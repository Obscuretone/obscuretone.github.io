...
The Conservatives are the party of market discipline and state suspicion. Their [2025 platform](https://canada-first-for-a-change.s3.us-west-2.amazonaws.com/20250418_CPCPlatform_8-5x11_EN_R1-pages.pdf) and [housing material](https://www.conservative.ca/conservatives-will-build-homes-for-canadians/) emphasize taxes, deficits, crime, national preference, red tape, homebuilding incentives, and making government smaller or less obstructive. Again, some constraints are real. Bad permitting and slow approvals can absolutely break housing supply. But if the state is treated mostly as the problem, there is no credible path to building the public capacity needed to make survival less dependent on private gatekeepers.
...
An unequal system is a dependency graph.

You do not change it by asking powerful people to be less powerful.

You change it by reducing the number of essential decisions they can control.
...
Replace "apply and wait" with entitlements the system can deliver by default.
...
An administrative state that can harm people by mistake, deny the appeal, hide the logs, and call the delay normal is already coercive.

The zero-downtime version of liberation is not asking the old system to become kind.

It is draining traffic from coercive paths until fewer people need permission from the people who benefit from denial.
...
Do not begin by promising to replace every private landlord at once.
...
Build public procurement, local food infrastructure, co-ops, anti-monopoly enforcement, and emergency food guarantees so basic food access is less dependent on a few concentrated chains.
...
Public retraining that respects adults.
...
Where did misuse appear?

Where did local administration resist or distort the policy?
...
If a housing program fails, the answer cannot be "let renters absorb the cost while the theory remains correct."

If a public service mistreats people, the answer cannot be "at least it is not private."
...
Second, map coercive chokepoints and reduce gatekeeper control.
...
The old system does not need to be replaced in one dramatic release.
