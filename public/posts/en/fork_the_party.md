...
This is where everything becomes difficult.

The idea can be coherent. The policy stack can make sense. The moral case can be strong. The migration plan can be careful, boring, observable, and designed around keeping the country running while power is moved away from coercive chokepoints.
...
People do not join a movement because they read a perfect policy document and calmly update their priors. They join because it gives them language, belonging, hope, status, work, friendship, and something to do on a Tuesday night.
...
You can define the worldview clearly: public reliability, dependency reduction, zero-downtime transition, ownership migration, public capacity, anti-rent-seeking, automatic rights, visible failure, reversible policy, and fewer systems that can trap ordinary people.
...
Keep them from creating avoidable public controversies.
...
Submitting that pull request would be difficult.
...
The conversion would be tempting because the surface words almost compile.
...
For the People's Party, a philosophical ship of Theseus in rough water.
...
Starting a new party is clean and extremely difficult.
